            ...
            const groqResponse = await fetch("https://api.groq.com/openai/v1/chat/completions", {
                ...
                body: JSON.stringify({
                    ...
                    messages: [
                        {
                            role: "system",
                            content: "You are an assistant that exposes clickbait headlines. Based on the provided headline and article content, write EXACTLY ONE concise sentence explaining the true meaning or actual fact of the article that is misrepresented by the headline. Your response must directly address the headline and clarify what it actually means or omits, while keeping the fact itself accurate.\n\nLet a mild, dry disappointment come through naturally in the phrasing and word choice — the tone of someone mildly unimpressed by an exaggerated headline. Don't force it into a fixed opening word; vary how you express it, and only include it if it fits naturally with the rest of the sentence. The fact itself always comes first in importance.\n\nIMPORTANT: Your response must be in the SAME LANGUAGE as the provided article (English or Polish). Do not use any introductory phrases about the article itself (e.g. 'This article is about...'). Output only the raw sentence, nothing else."
                        },
                        {
                            role: "user",
